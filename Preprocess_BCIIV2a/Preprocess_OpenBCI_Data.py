...
class OpenBCIPreprocessor:
    ...
    """
    def __init__(self, subj_list, path='M:/RA Spring 24/Transformer_openbci/dataset_openbci/', band=[0.5, 40], interval=[150, 350]):
        """
    ...
    def _select_channels(self):
        ...
        Returns:
        - list: List of selected channel indices.
        """
        ch_idx = []
        for i in self.CH:
            if 'C' in i:
    ...
    def segment_data(self, cnt_data, marker, interval):
        ...
        Parameters:
        - cnt_data: Numpy array containing continuous data.
        - marker: Numpy array containing marker positions.
        - interval: List containing start and end indices of the desired segment.

        Returns:
        - seg_data: List of segmented data arrays.
        """
    ...
    def x_reshape(self, array):
        ...
        Returns:
        - numpy.ndarray: Reshaped data into (trials,channels,samples)
        """
    ...
    def load_and_preprocess_data(self):
        ...
        Returns:
        - lists: Lists containing train and test data and labels.
        """
